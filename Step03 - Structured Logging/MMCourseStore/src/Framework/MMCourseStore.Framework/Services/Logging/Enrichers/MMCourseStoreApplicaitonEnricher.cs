...
namespace MMCourseStore.Framework.Services.Logging.Enrichers;
public class MMCourseStoreApplicaitonEnricher : ILogEventEnricher
{
    private readonly SerilogApplicationEnricherOptions _options;
    public MMCourseStoreApplicaitonEnricher(IOptions<SerilogApplicationEnricherOptions> options)
    {
